package pid.fsoft.tactictest.ui.crawljax.plugins;
 ...
 */
public class TacticTestOnUrlFirstLoadPlugin implements OnUrlFirstLoadPlugin {

    private static final Logger logger = TacticTestLogger.getLogger(TacticTestOnUrlFirstLoadPlugin.class);
     ...
     */
    public TacticTestOnUrlFirstLoadPlugin(TomlTable[] preCrawlActions) {
