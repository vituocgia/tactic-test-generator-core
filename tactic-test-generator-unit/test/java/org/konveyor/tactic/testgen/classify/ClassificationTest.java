...
package pid.fsoft.tactic.testgen.classify;
...
public class ClassificationTest {
    ...
    public void testClassification() throws Exception {
        ...
        ArrayNode resultArray = (ArrayNode) TacticTestJson.getObjectMapper().readTree(new File(OUTPUT_PATH));
        ArrayNode standardArray = (ArrayNode) TacticTestJson.getObjectMapper().readTree(new File(COMPARE_OUTPUT_PATH));
