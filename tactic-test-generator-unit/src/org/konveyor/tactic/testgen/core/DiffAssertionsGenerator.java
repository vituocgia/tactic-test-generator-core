...
import pid.fsoft.tactic.testgen.core.executor.SequenceExecutor.SequenceInfo;
import pid.fsoft.tactic.testgen.core.executor.SequenceExecutor.SequenceResults;
...
public class DiffAssertionsGenerator {
	...
	private static final Logger logger = TacticTestLogger.getLogger(DiffAssertionsGenerator.class);
