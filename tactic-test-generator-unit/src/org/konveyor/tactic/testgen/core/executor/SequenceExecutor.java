...
package pid.fsoft.tactic.testgen.core.executor;
...
import pid.fsoft.tactic.testgen.core.SequenceParser;
...
public class SequenceExecutor {
	...
	private static final Logger logger = TacticTestLogger.getLogger(SequenceExecutor.class);
