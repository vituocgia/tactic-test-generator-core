...
import pid.fsoft.tactic.testgen.model.CTDModeler.CTDModelAndTestPlan;
...
public class CTDTestPlanGenerator {
	...
	private static final Logger logger = TacticTestLogger.getLogger(CTDTestPlanGenerator.class);

	private static ObjectMapper mapper = TacticTestJson.getObjectMapper();
